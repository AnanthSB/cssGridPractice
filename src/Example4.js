...
export default function Example3(props) {
    ...
    const [repeat,setRepeat] = useState('repeat(3,100px)');

  return (
      <div id="example2" className='mx-auto w-full my-3 h-[100vh]'>
        <div className='relative w-full flex justify-center'>
          <div className='exampleH1 absolute left-[10px] top-[10px] z-[5]'>
            <h1 className='text-black font-semibold italic text-[22px] '>Example:4 - Content Control</h1>
          </div>
          <div className='relative flex flex-col justify-center items-center h-[614px] w-[70%] border'>
              <div style={{gridTemplateColumns:repeat}} className={`itemBoxContainer ${display} z-0 min-h-[300px] h-[650px] max-h-[560px] min-w-[250px] w-1/2 max-w-[70%] resize overflow-auto relative content-${columnAi} justify-${columnJi} gap-[8px]`}>
          ...
          <div className=''>
            <table>
              ...
              <tr className='text-left'><td className='pt-[4px] font-[500] px-[2px]'>grid-template-columns:</td>
                <td disabled={false}>
                <button className="py-2 px-1">
                    <span onClick={(e)=>{setRepeat(e.target.id)}} id="repeat(3,100px)" className={`${repeat==='repeat(3,100px)' ? 'text-white border-blue-700 bg-blue-500 hover:bg-blue-700':'text-black'} px-1 bg-grey-500 font-semibold  border rounded title="Sorry you can't change it`}>
                      repeat(3,100px)
                    </span>
                  </button>,
                  <button className="py-2 px-1">
                  ...
                  <button className="py-2 px-1">
                    <span onClick={(e)=>{setRepeat(e.target.id)}} id="repeat(4,1fr)" className={`${repeat==='repeat(4,1fr)' ? 'text-white border-blue-700 bg-blue-500':'text-black'} hover:bg-blue-400 px-1 bg-grey-500 font-semibold  border rounded title="Sorry you can't change it`}>
                      repeat(4,1fr)
                    </span>
                  </button>,
                  <button className="py-2 px-1">
              ...
              <tr className='text-left'><td className='pt-[4px] font-[500] px-[2px]'>justify-content:</td>
                <td disabled={false}>
                  ...
                  <button className="py-2 px-1">
                    <span id="between" onClick={(e)=>{setColumnJi(e.target.id)}} className={`${columnJi==="between"?'bg-blue-500 text-white':''} hover:bg-blue-400 px-1 font-semibold  border border-blue-700 rounded`} title=" items are evenly distributed in the line with equal space around them">
                      space-between
                    </span>
                  </button>,
                  <button className="py-2 px-1">
                    <span id="around" onClick={(e)=>{setColumnJi(e.target.id)}} className={`${columnJi==="around"?'bg-blue-500 text-white':''} hover:bg-blue-400 px-1 font-semibold  border border-blue-700 rounded`} title=" items are evenly distributed in the line with equal space around them">
                      space-around
                    </span>
                  </button>
                  <button className="py-2 px-1">
                    <span id="evenly" onClick={(e)=>{setColumnJi(e.target.id)}} className={`${columnJi==="evenly"?'bg-blue-500 text-white':''} hover:bg-blue-400 px-1 font-semibold  border border-blue-700 rounded`} title=" items are evenly distributed in the line with equal space around them">
                      space-evenly
                    </span>
                  </button>
                </td> 
              ...
              <tr className='text-left'><td className='pt-[4px] font-[500] px-[2px]'>align-content:</td>
                  <button className="py-2 px-1">
                  ...
                  <button className="py-2 px-1">
                    <span id="between" onClick={(e)=>{setColumnAi(e.target.id)}} className={`${columnAi==="between"?'bg-blue-500 text-white':''} hover:bg-blue-400 px-1 font-semibold  border border-blue-700 rounded`} title="This means the flexbox items will be centered vertically.">
                      space-between
                    </span>
                  </button>,
                  <button className="py-2 px-1">
                    <span id="around" onClick={(e)=>{setColumnAi(e.target.id)}} className={`${columnAi==="around"?'bg-blue-500 text-white':''} hover:bg-blue-400 px-1 font-semibold  border border-blue-700 rounded`} title="This means the flexbox items will be centered vertically.">
                      space-around
                    </span>
                  </button>,
                  <button className="py-2 px-1">
                    <span id="evenly" onClick={(e)=>{setColumnAi(e.target.id)}} className={`${columnAi==="evenly"?'bg-blue-500 text-white':''} hover:bg-blue-400 px-1 font-semibold  border border-blue-700 rounded`} title="This means the flexbox items will be centered vertically.">
                      space-evenly
                    </span>
                  </button>
              </tr>
